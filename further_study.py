...
def custom_remove(input_list, value):
    ...
    for item in input_list:
        if item == value:
            last_items = input_list[n+1:]
            input_list = input_list[:n]
            for thing in last_items:
                custom_append(input_list, thing)
            break
        n += 1
